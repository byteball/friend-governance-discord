	...
	switch (event.type) {
		case "added_support":
			msg.setTitle('Support added in ' + aa_name)
				.setDescription(description + ' adds ' + event.added_support + ' votes' + ' in support of value `' + event.value + '` of parameter `' + event.name + '`'
				)
				.addFields(
